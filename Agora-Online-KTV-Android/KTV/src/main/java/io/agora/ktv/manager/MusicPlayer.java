...
//        stopDisplayLrc();
        ...
        onMusicOpening();
        //int ret = mRtcEngine.startAudioMixing(fileMusic.getAbsolutePath(), false, 1, 1);
        int ret = mRtcEngine.startAudioMixing("/sdcard/Download/song/661222.mp4", false, 1, 1);
    ...
    public void selectAudioTrack(int i) {
        ...
        Log.i("test", "track count:" + mRtcEngine.getAudioTrackCount() + ",mAudioTrackIndex=" + mAudioTrackIndex);
...
//        mAudioTracksCount = mRtcEngine.getAudioTrackCount();
    ...
    public void onAudioMixingStateChanged(int state, int errorCode) {
        ...
        if (state == Constants.AUDIO_MIXING_STATE_PLAYING) {
            ...
            onMusicStop();
            onMusicCompleted();
        } else if (state == Constants.WARN_AUDIO_MIXING_OPEN_ERROR) {
